...
using InfraFlow.Core.EntityFramework.Enums;
...
{
    public static void ApplyGlobalConfigurations(this ModelBuilder builder, DbContext context)
    {
    ...
    public static void ApplyGlobalEntityConfigurations<T>(this EntityTypeBuilder<T> builder, DatabaseProviderTypes databaseProviderTypes = DatabaseProviderTypes.SqlServer) where T : class
    {
